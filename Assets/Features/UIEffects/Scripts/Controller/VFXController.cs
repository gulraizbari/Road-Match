...
namespace Features.UIEffects
{
    public class VFXController : MonoBehaviour
    {
        ...
        {
            action?.Invoke();
            SoundManager.Instance.Notification(1);
            ...
            // _popUpSequence1.Append(_goalPrefab.transform.DOScale(.55f, 0.4f).SetEase(Ease.OutBack));
            // _popUpSequence1.Append(_goalPrefab.transform.DOScale(0.45f, 0.4f).SetEase(Ease.InBack));
            ...
            //     _popUpSequence2.Join(_goalPrefab.transform.DOScale(0.1f, 0.5f).SetEase(Ease.OutBack));
